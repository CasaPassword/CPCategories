...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CPCategories
                   DESC

  s.homepage     = "https://github.com/CasaPassword/CPCategories"
  ...
  s.source       = { :git => "https://github.com/CasaPassword/CPCategories.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CPCategories/CPCategories/**/*.{h,m}"
